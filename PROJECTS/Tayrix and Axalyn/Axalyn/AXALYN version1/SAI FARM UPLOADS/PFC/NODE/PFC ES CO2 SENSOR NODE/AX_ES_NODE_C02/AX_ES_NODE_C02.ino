...
const char* mqttServer = "192.168.1.102"; //"192.168.1.166"; //"192.168.1.166";// "192.168.1.107";//"192.168.1.183";//"192.168.1.102";
...
const char* sendtopic_CT = "Chinnamangalaram/GH1/ES/ZoneA/ClimateData";
...
void sendDataMQTT() {
  ...
  //  serializeJsonPretty(doc, msgStr);/

  //  serializeJsonPretty(doc, Serial);/
  //    /msgStr = "{"TXCC": {"did": "ESP8266","timeStamp": "File","csn1_livedata":{"AT_v":29.00,"RH_v":60.00,"VPD_v":1.00,"HI_v":28.00,"ntl_v":70.00}}}";
  //    msgStr = "{\"csn1__id\"}";
  //    byte arrSize = msgStr.length() + 1;
  //    char msg[arrSize];
  //    Serial.print("PUBLIS CC_CSN01_DATA:");
