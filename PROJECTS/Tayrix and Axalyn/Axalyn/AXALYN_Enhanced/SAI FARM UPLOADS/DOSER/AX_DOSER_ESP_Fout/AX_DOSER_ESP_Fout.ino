...
char ssid[] = "Zeptogreens";  //  your network SSID (name)
char pass[] = "Zeptogreens@2023";       // your network password

#define LED 2
bool MQTT_Flag;
Scheduler r;
const char* mqttServer = "192.168.1.101";//"192.168.1.102"; //MQTT URL 192.168.1.16
const int port = 1883;
const char* mqttUserName = "svaasafarm"; // "username"; // "Zeptogreens";  // MQTT username
const char* mqttPwd = "svaasafarmmqtt";//"12345";  // MQTT password
