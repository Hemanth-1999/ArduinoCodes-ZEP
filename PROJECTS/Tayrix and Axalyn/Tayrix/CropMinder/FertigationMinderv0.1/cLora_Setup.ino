...
void onReceive(int packetSize) {
  ...
  if (sender == 0xCC)
  {
    Serial.println("From WeatherMinder");
    String at = getValue(incoming, ',', 0);
    String vpd = getValue(incoming, ',', 1);
    String et = getValue(incoming, ',', 2);
    String rh = getValue(incoming, ',', 3);
    String bp = getValue(incoming, ',', 4);
    String sl = getValue(incoming, ',', 5);
    String dp = getValue(incoming, ',', 6);
  ...
  if (sender == 0xDD)
  {
    Serial.println("From Foliage Minder");
