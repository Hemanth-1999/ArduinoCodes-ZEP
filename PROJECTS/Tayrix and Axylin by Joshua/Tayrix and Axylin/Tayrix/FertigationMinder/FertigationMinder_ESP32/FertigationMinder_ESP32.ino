...
/*==============================================
  Declrations
  ==============================================*/
IPAddress ntpServer(132, 163, 4, 101); // IP address of the NTP server
EthernetUDP  udpClient;
NTPClient timeClient(udpClient, ntpServer);
const int timeZoneOffset = 19800; // Timezone offset for India in seconds (+5:30)
#define ss 17
#define rst 35
#define dio0 39
...
void loop() {
  ...
  // Get NTP values
  time_t rawTime = timeClient.getEpochTime() + timeZoneOffset;
  ...
  Serial.print("Current Date & Time in India: ");
  Serial.print(timeInfo->tm_year + 1900); // Year starts from 1900
  Serial.print("-");
  Serial.print(timeInfo->tm_mon + 1); // Month starts from 0
  Serial.print("-");
  ...
  delay(1000); // Delay between NTP updates
}
