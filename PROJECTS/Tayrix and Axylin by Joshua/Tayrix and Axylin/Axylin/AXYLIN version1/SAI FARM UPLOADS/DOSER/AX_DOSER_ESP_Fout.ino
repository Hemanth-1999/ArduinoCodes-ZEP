...
bool MQTT_Flag;
Scheduler r;
const char* mqttServer = "192.168.0.173";//"192.168.1.102"; //MQTT URL 192.168.1.16
const int port = 1883;
const char* mqttUserName = "Zeptogreens"; // "username"; // "Zeptogreens";  // MQTT username
const char* mqttPwd = "123456";//"12345";  // MQTT password
