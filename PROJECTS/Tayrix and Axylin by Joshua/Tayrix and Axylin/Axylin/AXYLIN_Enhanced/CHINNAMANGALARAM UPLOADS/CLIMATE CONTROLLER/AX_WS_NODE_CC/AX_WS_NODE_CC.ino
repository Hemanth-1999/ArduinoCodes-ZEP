...
const char* mqttServer = "192.168.0.197"; //"192.168.1.166";// "192.168.1.107";//"192.168.1.183";//"192.168.1.102";
...
const char* sendtopic_Mesh = "account/Zepto/clientid/appid/climatedata/WS";
