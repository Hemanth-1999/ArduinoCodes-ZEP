...
Description: lxml is a Pythonic, mature binding for the libxml2 and libxslt libraries.  It
        ...
        available at
        https://github.com/lxml/lxml/tree/lxml-4.8 .
        Running ``easy_install lxml==4.8bugfix`` will install
        the unreleased branch state from
        https://github.com/lxml/lxml/tarball/lxml-4.8#egg=lxml-4.8bugfix
