...
void onReceive(int packetSize) {
  ...
  if (Val == 30)
    ...
    Mymessage = Mymessage  + chipId + "," + soilMoistureValue + "," + soil1 + "," + soilMoistureValue + "," + soil2 + "," + temperature + "," + Pressure + "," + humidity  + "," + temperatureC + "," + temperatureF + "," + lat_str + "," + lng_str;    
...
void sendMessage(String outgoing, byte MasterNode, byte Node3) {
  ...
  LoRa.write(Node3);             // add sender addresss
...
int GetSoilVal(int pin) {
  ...
  soilmoisturepercent = map(soilMoistureValue, 2796, 1366, 0, 100);
