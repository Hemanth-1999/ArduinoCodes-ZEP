...
const char* node1 = "msnode";
const char* farm1 = "val1";
const char* field1 = "val2";
const char* zone1 = "zone1";
...
void onReceive(int packetSize) {
  ...
  if (Val == 10)
    ...
    Mymessage = Mymessage  + chipId + "," + node1 + "," + farm1 + "," + field1 + "," + zone1 + "," + 17.78 + "," +  65.98;    
