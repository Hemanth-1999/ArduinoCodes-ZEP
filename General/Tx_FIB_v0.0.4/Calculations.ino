...
float NUTRIENTNEX()
{
  ...
  if ( nutreintstats == true)
  {
    ...
    nutreintstats = false;
    Serial.println("nitrogen dosing time:");
  ...
  if ( pstats == true)
  {
    ...
    pstats = false;
    Serial.println("phosphorus  dosing time :");
  ...
  if ( kstats == true)
  {
    ...
    kstats = false;
    Serial.println("potassium  dosing time :");
...
void NPKcal()
{
  ...
  Serial.println(mango[0]);
  Serial.println(" ");
  Serial.println("P val  ");
  Serial.println(mango[1]);
  Serial.println(" ");
  Serial.println("K val  ");
  Serial.println(mango[2]);
  Serial.println(" ");
  Serial.println("ph val  ");
  Serial.println(mango[3]);
  Serial.println(" ");
  Serial.println("S val  ");
  Serial.println(mango[4]);
}
