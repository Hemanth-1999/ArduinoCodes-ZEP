...
uint8_t EepromZ2ZPBSThr = 364;
uint8_t EepromZ2ZPBSTmin = 366;
uint8_t EepromZ2ZPBSPhr = 368;
uint8_t EepromZ2ZPBSPmin = 370;


uint8_t EepromZ2APSThr = 372;
uint8_t EepromZ2APSTmin = 374;
uint8_t EepromZ2APSPhr = 376;
uint8_t EepromZ2APSPmin = 378;

uint8_t EepromZ2ZAPSThr = 380;
uint8_t EepromZ2ZAPSTmin = 382;
uint8_t EepromZ2ZAPSPhr = 384;
uint8_t EepromZ2ZAPSPmin = 386;
...
//    ////Serial.println(buff);
    ...
    if ((data_from_display.substring(0, 5) == "apaz1")) {//.substring(0, 5)
     ...
     if ((data_from_display.substring(0, 5) == "apaz2")) {//.substring(0, 5)
      ...
      Serial.print("othr: ");
      Serial.println(Z2PASThr);                  

      Serial.print("otMin: ");
      Serial.println(Z2PASTmin);               
      
      Serial.print("oftHr: ");
      Serial.println(Z2PASPhr);                  
     ...
     if ((data_from_display.substring(0, 5) == "apbz1")) {//.substring(0, 5)
    ...
    if ((data_from_display.substring(0, 5) == "apbz2")) {//.substring(0, 5)

      Z2PBsavetime();
      Z2PBsavedue();

      Serial.print("othr: ");
      Serial.println(Z2PBSThr);                  

      Serial.print("otMin: ");
      Serial.println(Z2PBSTmin);               
      
      Serial.print("oftHr: ");
      Serial.println(Z2PBSPhr);                  

      Serial.print("oftMin: ");
      Serial.println(Z2PBSPmin);
      feedBack = "saved"; 
    }
    ...
    if ((data_from_display.substring(0, 5) == "apdz1")) {//.substring(0, 5)
    ...
    if ((data_from_display.substring(0, 5) == "apdz2")) {//.substring(0, 5)

      Z2APsavetime();
      Z2APsavedue();

      Serial.print("othr: ");
      Serial.println(Z2APSThr);                  

      Serial.print("otMin: ");
      Serial.println(Z2APSTmin);               
      
      Serial.print("oftHr: ");
      Serial.println(Z2APSPhr);                  
...
//    timedata();
  ...
  //***********COUNTER ****************************************
  //Zone 1
//  PUMPAON.setCounter(Z1PASThr, Z1PA_Min_On, Z1PA_Min_On, PUMPAON.COUNT_UP, PUMPAONComplete);//PUMPAOFF start
//  PUMPAON.setInterval(print_timePUMPA1, 1000);
//  PUMPAOFF.setCounter(Z1PASPhr, Z1PA_Min_Off, Z1PA_Min_Off, PUMPAOFF.COUNT_DOWN, PUMPAOFFComplete);//PUMPAON start
//  PUMPAOFF.setInterval(print_timePUMPA2, 1000);
//  // PUMPANone.setInterval(print_nonePUMPA, 2000);
//  //
//  PUMPBON.setCounter(Z1PBSThr, Z1PBSTmin, Z1PBSTmin, PUMPBON.COUNT_UP, PUMPBONComplete);
...
//  //
//  AIRSTONEON.setCounter(Z1APSThr, 1, 1, AIRSTONEON.COUNT_UP, AIRSTONEONComplete);
//  AIRSTONEON.setInterval(print_timeAIRSTONE1, 1000);
//  AIRSTONEOFF.setCounter(Z1APSPhr, 2, 2, AIRSTONEOFF.COUNT_DOWN, AIRSTONEOFFComplete);
//  AIRSTONEOFF.setInterval(print_timeAIRSTONE2, 1000);
//  //   AIRSTONEone.setInterval(print_noneAIRSTONE, 2000);
//
//  //Zone 2
