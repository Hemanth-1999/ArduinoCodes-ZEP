...
uint32_t chipid;
//const char* ssid = "CENAURA";//Kumar_Xstream
//const char* password =  "india@123";//703664703664
const char* mqttServer = "api.tayrix.com"; //"192.168.1.166";// "192.168.1.107";//"192.168.1.183";//"192.168.1.102";
...
//  TXCC_ES_rtd["RH_v"] = "25"; //(float)(E_RH) / 10;
//  int E_VPD = (int)(VPDcal() * 10);
//  TXCC_ES_rtd["VPD_v"] = "25"; //(float)(E_VPD) / 10;
//  int E_HI = (int)(HI * 10);
//  TXCC_ES_rtd["HI_v"] = "25"; //(float)(E_HI) / 10;
//  TXCC_ES_rtd["Co2_v"] = sensorValue1;
//  int E_ETo = (int)(ETo * 10);
//  TXCC_ES_rtd["ET_v"] = "25"; //(float)(E_ETo) / 10;
//  int E_BP = (int)(ES_BP * 10);
//  TXCC_ES_rtd["BP_v"] = "65"; //(float)(E_BP) / 10;
//  TXCC_ES_rtd["SR_v"] = uvIntensity * 10;
//  int E_DP = (int)(dewpt * 10);
//  TXCC_ES_rtd["DP_v"] = "55"; //(float)(E_DP) / 10;
//  TXCC_ES_rtd["SL_v"] = sl;
