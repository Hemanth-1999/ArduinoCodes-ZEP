...
const char* certificate = "c2e_hono_truststore.pem";
...
uint32_t chipid;
const char* mqttServer = "cea.axalyn.com"; //"192.168.1.38";
const int mqttPort = 1883;
const char* mqttUserName = "axalyn"; //"tayrix"; //"Zeptogreens";
const char* mqttPwd = "cenaura@2024"; //"zepto@2023"; // "12345";
...
/* https://www.youtube.com/watch?v=1y03xt6IM-o
   Example program how to upload a code inSPIFFS */

String readPemFile() {

//  File file = SPIFFS.open("/c2e_hono_truststore.pem");

    DynamicJsonDocument doc(1024);
    
    doc["hostname"] = mqttServer;
    doc["port"] = mqttPort;
    doc["clientid"] = clientID;
    doc["user"] = mqttUserName;
    doc["password"] = mqttPwd;
    doc["topic"] = send_Topic;

    File file = SPIFFS.open("/params.json");
  if (!file) {
